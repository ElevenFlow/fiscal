...
/**
 * Webhook Clerk → Postgres (Plan 01-07; religado pelo Plan 02-09).
 *
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // T-02-09-03: nunca vazar detalhes do erro de assinatura (evita oracle de sniffing).
